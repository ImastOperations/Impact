...
public class AsmAdapter extends RecyclerView.Adapter<AsmAdapter.RecylerviewViewholder> {
    private final InvoiceInterface buttonListener;
    Context context;
    private ArrayList<AreaSalesModal> arrayList;
    private String get_idd;
    private String get_name;

    public AsmAdapter(Context mcontext, ArrayList<AreaSalesModal> arrayList, InvoiceInterface buttonListener) {
        context = mcontext;
